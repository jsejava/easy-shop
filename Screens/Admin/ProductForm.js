...
const ProductForm = (props) => {
  ...
  useEffect(() => {
    ...
    (async () => {
      if (Platform.OS !== "web") {
        ...
        if (status !== "granted") {
          alert("sorry, we need camera roll permition");
        }
      }
    })();
    return () => {
  ...
  return (
    <FormContainer title="Add Product">
      ...
      />
      <View style={styles.label}>
        <Text style={{ textDecorationLine: "underlined" }}>Price</Text>
      </View>
      <Input
        placeholder="Price"
        name="Price"
      ...
      />
      <View style={styles.label}>
        <Text style={{ textDecorationLine: "underlined" }}>Stock in Stock</Text>
      </View>
      <Input
        placeholder="Stock"
        name="Stock"
      ...
      />
      <View style={styles.label}>
        <Text style={{ textDecorationLine: "underlined" }}>Description</Text>
      </View>
      <Input
